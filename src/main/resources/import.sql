...
values ("Brabas", 9.0, 1)
    insert
into restaurante (nome, taxa_frete, cozinha_id)
values ("Shinobis", 10.0, 2)
...
values ("admin", "dono da porra toda")
insert into permissao (nome, descricao)
values ("usuario", "só pode visualizar")
insert into permissao (nome, descricao)
values ("gerente", "consegue alterar itens da sua loja")
