...
<p>Olá ${pedido.cliente.nome}, lamentamos informar que seu pedido foi cancelado.</p>
...
<p>Se tiver alguma dúvida ou precisar de assistência adicional, por favor, entre em contato conosco.</p>

<p>Atenciosamente,<br>Equipe do ${pedido.restaurante.nome}</p>
</body>
</html>
