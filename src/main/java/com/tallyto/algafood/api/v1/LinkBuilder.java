package com.tallyto.algafood.api.v1;

import com.tallyto.algafood.api.v1.controller.*;
...
public class LinkBuilder {
    ...
    public Link linkToGrupoPermissoes(Long grupoId, String rel) {
        return WebMvcLinkBuilder.linkTo(methodOn(GrupoPermissoesController.class)
